package com.airgradient.android.ui.theme

import androidx.compose.ui.graphics.Color

// Primary brand colors - Blue theme to match iOS
val md_theme_light_primary = Color(0xFF1976D2) // Blue
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFD1E4FF)
val md_theme_light_onPrimaryContainer = Color(0xFF001D35)

val md_theme_light_secondary = Color(0xFF5C6773) // Neutral gray accent
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFE1E4E9)
val md_theme_light_onSecondaryContainer = Color(0xFF1F252C)
...
val md_theme_dark_secondary = Color(0xFFC2C7CF)
val md_theme_dark_onSecondary = Color(0xFF2B3037)
val md_theme_dark_secondaryContainer = Color(0xFF424850)
val md_theme_dark_onSecondaryContainer = Color(0xFFDEE2EA)
